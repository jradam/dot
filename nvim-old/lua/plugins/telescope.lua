return {
  ...
  -- FIXME move to own file
  {
    ...
    keys = {
      { "<leader>gl", ":Easypick<cr>", desc = "Git telescope" },
    },
    config = function()
        ...
        pickers = {
          {
            ...
            opts = require("telescope.themes").get_dropdown({
              -- FIXME why not overwrite defaults??
              -- FIXME or just remove preview_height from defaults, and apply manually to all other pickers
              layout_config = nil,
            }),
          },
          {
            name = "changed",
            -- FIXME why not work with diff-so-fancy?
