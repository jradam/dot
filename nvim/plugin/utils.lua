...
-- TODO: Should not open lock files
-- TODO: Should not open deleted files
-- TODO: The fact that this can open deleted files is promising - make a Spy picker of all deleted files and select to restore.
